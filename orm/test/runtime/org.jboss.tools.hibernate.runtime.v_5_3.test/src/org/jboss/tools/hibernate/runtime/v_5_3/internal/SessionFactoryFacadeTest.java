...
import org.jboss.tools.hibernate.runtime.v_5_3.internal.test.Foo;
...
public class SessionFactoryFacadeTest {
	...
	public void testGetAllCollectionMetadata() {
		...
		Assert.assertNotNull(
				allCollectionMetaData.get(
						"org.jboss.tools.hibernate.runtime.v_5_3.internal.test.Foo.bars"));
	}
	...
	public void testGetCollectionMetadata() {
		...
		CollectionMetadata collectionMetadata = (CollectionMetadata)((MetamodelImplementor)metamodel)
				.collectionPersister("org.jboss.tools.hibernate.runtime.v_5_3.internal.test.Foo.bars");
		Assert.assertSame(
				collectionMetadata, 
