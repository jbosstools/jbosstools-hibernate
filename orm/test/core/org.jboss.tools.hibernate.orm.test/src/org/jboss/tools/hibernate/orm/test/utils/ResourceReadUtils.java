...
public class ResourceReadUtils {
	...
	private static final String BUNDLE_NAME = "org.jboss.tools.hibernate.orm.test";
	...
	public static File getResourceItem(String strResPath) throws IOException {
		...
		URL entry = getBundle().getEntry(strResPath);
    ...
    private static Bundle getBundle() {
    		return Platform.getBundle(BUNDLE_NAME);
    }
}
