...
import org.jboss.tools.hibernate.jpt.core.internal.context.persistence.JPA2_2;
 ...
 *
 */
public class HibernatePersistenceXml2_2UiDefinition extends AbstractResourceUiDefinition {

	// singleton
	private static final ResourceUiDefinition INSTANCE = new HibernatePersistenceXml2_2UiDefinition();
	 ...
	 */
	private HibernatePersistenceXml2_2UiDefinition() {
		super();
	}
	...
	public boolean providesUi(JptResourceType resourceType) {
		JptResourceType resType = ContentTypeTools.getResourceType(XmlPersistence.CONTENT_TYPE, JPA2_2.SCHEMA_VERSION);
