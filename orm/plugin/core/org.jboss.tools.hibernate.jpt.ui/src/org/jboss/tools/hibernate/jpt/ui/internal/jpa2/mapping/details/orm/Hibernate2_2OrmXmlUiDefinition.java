 ...
 *
 */
public class Hibernate2_2OrmXmlUiDefinition extends AbstractOrmXmlResourceUiDefinition {
	
	// singleton
	private static final ResourceUiDefinition INSTANCE = new Hibernate2_2OrmXmlUiDefinition();
	 ...
	 */
	private Hibernate2_2OrmXmlUiDefinition() {
		super();
	}
	...
	public boolean providesUi(JptResourceType resourceType) {
		JptResourceType jrt = ContentTypeTools.getResourceType(XmlEntityMappings.CONTENT_TYPE, JPA2_2.SCHEMA_VERSION);
