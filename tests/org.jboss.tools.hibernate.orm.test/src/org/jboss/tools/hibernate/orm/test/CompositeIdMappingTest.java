...
import org.jboss.tools.hibernate.orm.test.utils.Customization;
...
import org.jboss.tools.hibernate.orm.test.utils.Utils;
...
public class CompositeIdMappingTest {
	...
	private static final String packageName = "mapping.abstractembeddedcomponents.cid";
