...
public class TypeParametersMappingTest {
	...
	private static final String CFG_XML = 
		...
		"       <mapping resource='/mapping/typeparameters/Typedef.hbm.xml' /> \n" +
		"       <mapping resource='/mapping/typeparameters/Widget.hbm.xml' /> \n" +
		"	</session-factory>                                                                                        \n" +
		"</hibernate-configuration>                                                                                    " ;
	
	private static final String packageName = "mapping.typeparameters";
