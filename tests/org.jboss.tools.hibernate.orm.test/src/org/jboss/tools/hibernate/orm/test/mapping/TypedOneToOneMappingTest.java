...
public class TypedOneToOneMappingTest {
	...
	private static final String CFG_XML = 
		...
		"       <mapping resource='/mapping/typedonetoone/Customer.hbm.xml' /> \n" +
		"	</session-factory>                                                                                        \n" +
		"</hibernate-configuration>                                                                                    " ;
	
	private static final String packageName = "mapping.typedonetoone";
