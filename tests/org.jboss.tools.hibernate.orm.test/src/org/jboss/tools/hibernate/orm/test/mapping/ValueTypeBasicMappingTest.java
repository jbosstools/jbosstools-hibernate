...
public class ValueTypeBasicMappingTest {
	...
	private static final String CFG_XML = 
		...
		"       <mapping resource='/mapping/value/type/basic/BasicValueTypes.hbm.xml' /> \n" +
		"	</session-factory>                                                                                        \n" +
		"</hibernate-configuration>                                                                                    " ;
	
	private static final String packageName = "mapping.value.type.basic";
