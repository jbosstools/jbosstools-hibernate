...
public class VersionNodbMappingTest {
	...
	private static final String CFG_XML = 
		...
		"       <mapping resource='/mapping/version/nodb/PersonThing.hbm.xml' /> \n" +
		"	</session-factory>                                                                                        \n" +
		"</hibernate-configuration>                                                                                    " ;
	
	private static final String packageName = "mapping.version.nodb";
