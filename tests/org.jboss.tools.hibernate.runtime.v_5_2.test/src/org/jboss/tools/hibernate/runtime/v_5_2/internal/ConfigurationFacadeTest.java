...
public class ConfigurationFacadeTest {
	...
	public void testGetClassMappings() throws Exception {
		...
		Assert.assertEquals(
				"org.jboss.tools.hibernate.runtime.v_5_2.internal.ConfigurationFacadeTest$Foo", 
	...
	public void testGetTableMappings() throws Exception {
		...
		configurationFacade.setProperty("hibernate.dialect", "org.hibernate.dialect.H2Dialect");
