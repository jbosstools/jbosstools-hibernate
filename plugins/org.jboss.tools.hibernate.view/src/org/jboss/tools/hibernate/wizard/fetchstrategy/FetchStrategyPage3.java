 ...
 * dial with Eager fetching associations
 */
public class FetchStrategyPage3 extends WizardPage {
	public static final String BUNDLE_NAME = "fetchstrategy"; 
	public static final ResourceBundle BUNDLE = ResourceBundle.getBundle(FetchStrategyPage3.class.getPackage().getName() + "." + BUNDLE_NAME);	
	private List list;
	...
	public FetchStrategyPage3() {
		super("wizardPage");
		setTitle(BUNDLE.getString("FetchStrategyWizard.title"));
		setDescription(BUNDLE.getString("FetchStrategyPage3.description"));
	}
	
	/**
	 * refresh list of Eager fetching associations
	 */
