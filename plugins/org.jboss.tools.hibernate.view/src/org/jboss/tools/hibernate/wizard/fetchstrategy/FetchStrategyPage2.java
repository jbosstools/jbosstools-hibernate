 ...
 * dial with Lazy fetching associations
 */
public class FetchStrategyPage2 extends WizardPage {
	public static final String BUNDLE_NAME = "fetchstrategy"; 
	public static final ResourceBundle BUNDLE = ResourceBundle.getBundle(FetchStrategyPage2.class.getPackage().getName() + "." + BUNDLE_NAME);	
	private List list;
	...
	public FetchStrategyPage2() {
		super("wizardPage");
		setTitle(BUNDLE.getString("FetchStrategyWizard.title"));
		setDescription(BUNDLE.getString("FetchStrategyPage2.description"));
	}

	/**
	 * refresh list of Lazy fetching associations
	 */
