 ...
 *
 */
public class HibernateJpa2_1PlatformProvider extends AbstractJpaPlatformProvider {

	public static final String ID = "hibernate2_1"; //$NON-NLS-1$

	// singleton
	private static final JpaPlatformProvider INSTANCE =
		new HibernateJpa2_1PlatformProvider();
	 ...
	 */
	private HibernateJpa2_1PlatformProvider() {
		super();
	}
