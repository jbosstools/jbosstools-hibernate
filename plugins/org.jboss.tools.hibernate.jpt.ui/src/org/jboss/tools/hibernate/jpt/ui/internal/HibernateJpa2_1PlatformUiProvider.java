 ...
 * 
 */
public class HibernateJpa2_1PlatformUiProvider extends
		AbstractJpaPlatformUiProvider {

	// singleton
	private static final JpaPlatformUiProvider INSTANCE = new HibernateJpa2_1PlatformUiProvider();
	 ...
	 */
	private HibernateJpa2_1PlatformUiProvider() {
		super();
	}
