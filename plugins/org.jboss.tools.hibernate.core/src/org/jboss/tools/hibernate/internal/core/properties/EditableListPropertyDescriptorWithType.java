 ...
 * Aug 3, 2005
 */
public class EditableListPropertyDescriptorWithType extends
		EditableListPropertyDescriptor implements IDescriptorWithType{

	public EditableListPropertyDescriptorWithType(Object id, String displayName, String[] propertyValues,boolean isint,boolean isUseLeftRange,boolean isUseRightRange,Object leftRange,Object rightRange) {
		super(id, displayName, propertyValues);
		this.isint=isint;//if true - int else float
